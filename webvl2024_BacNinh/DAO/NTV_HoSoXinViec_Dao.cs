...
namespace webvl2024_BacNinh.DAO
{
    public class NTV_HoSoXinViec_Dao
    {
        ...
        public static List<KhachHang_TimViecLam> LinQ_HSTV(ModelBN db)
        {
        ...
        public static Object GetListLocationNTV_Skip(ModelBN dbc, int Sec, int pageSize, int Id)
        {
        ...
        public static Object GetListLocationNTV_NoSkip(ModelBN dbc, int Sec, int pageSize, int Id)
        {
            if (HttpContext.Current.Session["searchStrNTV"] != null)
            {
                string strTK = HttpContext.Current.Session["searchStrNTV"].ToString();
