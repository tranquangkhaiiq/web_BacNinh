...
namespace webvl2024_BacNinh.DAO
{
    public class Khachhang_trinhdo_nghiepvu_DAO
    {
        ...
        public static List<KhachHang_TrinhDo> Getlist_khachhangtrinhdo_Single(ModelBN db, int KH_id)
        {
        ...
        public static string GetName_TV(ModelBN dbc, string ten, int KHID)
        {
            string name = "";
            if (ten == "HoTen")
            {
        ...
        {
            var XoaNLD = dbc.Database.ExecuteSqlCommand("DELETE  FROM [VLBN].[dbo].[KhachHang_NghiepVu] where KH_ID=" + khachhangid);
            var XoaNLD2 = dbc.Database.ExecuteSqlCommand("DELETE  FROM [VLBN].[dbo].[KhachHang_TimViec_NgoaiNgu_2022] where KH_ID=" + khachhangid);
            var XoaNLD3 = dbc.Database.ExecuteSqlCommand("DELETE  FROM [VLBN].[dbo].[KhachHang_TimViec_TinHoc] where KH_ID=" + khachhangid);
            if (NghiepVu1 != 0)
            {
        ...
        public bool Xoa_InsertKhachHang_trinhdo(int TrinhDo_ID, int Nganh_ID,int Nghe_ID ,int khachhangid, int UserID)
        {
            ...
            {
                var XoaNLD_TrinhDo = dbc.Database.ExecuteSqlCommand("DELETE  FROM [VLBN].[dbo].[KhachHang_TrinhDo] where KH_ID=" + khachhangid);
