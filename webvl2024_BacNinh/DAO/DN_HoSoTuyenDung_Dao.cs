...
namespace webvl2024_BacNinh.DAO
{
    public class DN_HoSoTuyenDung_Dao
    {
        ...
        //private static List<DoanhNghiep_TuyenDung> LinQ_DN_TD_StrAPI(ModelBN db, string str)
        //{
        ...
        //}
        public static List<DoanhNghiep_TuyenDung> LinQ_DN_TD(ModelBN db)
        {
            var model = db.Database.SqlQuery<DoanhNghiep_TuyenDung>("exec GetBase_DN_TD_khai").ToList();
            return model;
        }
        public static List<DoanhNghiep_TuyenDung> LinQ_DN_TD_Pay(ModelBN db)
        {
        ...
        private static List<DoanhNghiep_TuyenDung> LinQ_TDbyDN(ModelBN db, int DNID)
        {
